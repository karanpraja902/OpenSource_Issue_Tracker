...
const OrganizationDetails = () => {
  ...
  return (
    <div className="p-8 bg-transparent text-gray-300 h-screen m-auto overflow-auto">
      {/* Floating Button for Mobile View */}
      <div className="fixed top-4 right-4 z-50 md:hidden">
        <button
          onClick={scrollToIssues}
          className="bg-gradient-to-r from-green-700 via-green-600 to-green-900 hover:bg-green-700 text-white px-3 py-1 rounded-full shadow-lg flex items-center gap-2"
        >
          <span>Popular Issues</span>
      ...
      {orgDetails ? (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Main Content */}
          <div className="col-span-2 bg-transparent border-2 h-screen overflow-auto rounded-lg shadow-lg">
            <div className="p-6">
              {/* Header Section */}
          ...
          {/* Issues Section */}
          <div
            className="bg-transparent border-2 rounded-lg shadow-lg h-screen overflow-auto"
            ref={issuesRef}
          >
